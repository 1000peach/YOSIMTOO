...
int main()
{
	...
	PlaySound(TEXT("./sounds/drama.wav"), NULL, SND_ASYNC | SND_LOOP);
	...
	GameMapDelete();
	PlaySound(TEXT("./sounds/drama2.wav"), NULL, SND_ASYNC | SND_LOOP);
	Drama2();
	PlaySound(NULL, NULL, SND_PURGE | SND_NOWAIT | SND_ASYNC);

	if (sum_score <= 20)
	{
		PlaySound(TEXT("./sounds/엔딩1.wav"), NULL, SND_ASYNC | SND_LOOP);
		GameMapDelete();
		Ending1();
		Sleep(10000);
	}
	...
	{
		PlaySound(TEXT("./sounds/엔딩2.wav"), NULL, SND_ASYNC | SND_LOOP);
		GameMapDelete();
		Ending2();
		Sleep(10000);
	}
